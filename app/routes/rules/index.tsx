  ...
  return (
    <Wrapper activePage="rules">
      <div className="mx-auto flex w-full flex-1 flex-col justify-start pr-2 font-light md:max-w-[40ch] md:pr-0 lg:max-w-[60ch] xl:max-w-[75ch]">
        ...
        <p className="mt-12">
          <span className="bg-white">
            Обов’язково відмічайте паркомісце та їх необхідну кількість при
            бронюванні якщо плануєте заїжджати на авто!
          </span>
        </p>
        <p className="mt-2">
          <span className="bg-white">
            За одним бронюванням можливо закріпити одне безкоштовне місце,
            додаткові – 50 грн/год. Оплатити додаткові місця можна на місці у
            адміністратора.
          </span>
        </p>
        <p className="mt-2">
